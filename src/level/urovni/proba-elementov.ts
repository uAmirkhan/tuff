...
export const UROVEN_PROBA: Uroven = {
  ...
  obekty: [
    ...
    { tip: 'potok', id: 'vent', x: 35, y: 0, w: 2, h: 9, silaX: 0, silaY: 14, period: 6 },
    // коромысло у левой стены с контейнером-противовесом
    { tip: 'koromyslo', id: 'kor', x: 32, y: 2.5, w: 4, h: 0.3, os: 0.5 },
    { tip: 'yashchik', id: 'protivoves', x: 33.2, y: 3, w: 0.7, h: 0.7 },
