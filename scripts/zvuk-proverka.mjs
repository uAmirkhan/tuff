...
await page.addInitScript(() => {
  ...
  AudioContext.prototype.createOscillator = function () { w.__uzlov++; return orig.call(this); };
  const origB = AudioContext.prototype.createBufferSource;
  AudioContext.prototype.createBufferSource = function () { w.__uzlov++; return origB.call(this); };
});
...
await page.keyboard.down('KeyL'); await page.waitForTimeout(300); await page.keyboard.up('KeyL');
await page.keyboard.down('Space'); await page.waitForTimeout(300); await page.keyboard.up('Space');
await page.keyboard.down('KeyJ'); await page.waitForTimeout(300); await page.keyboard.up('KeyJ');
